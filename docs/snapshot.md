...
| `spec.s3.prefix`         | `Required`. Path prefix in Bucket                                               |
...
| `spec.gcs.prefix`        | `Required`. Path prefix in Bucket                                               |
...
| `spec.azure.prefix`      | `Required`. Path prefix in container                                            |
...
| `spec.swift.prefix`      | `Required`. Path prefix in container                                            |
