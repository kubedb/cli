...
```console
 $ kubectl create configmap -n demo pg-custom-config --from-file=https://raw.githubusercontent.com/kubedb/cli/0.9.0-rc.1/docs/examples/postgres/custom-config/user.conf 
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/kubedb/cli/0.9.0-rc.1/docs/examples/postgres/custom-config/pg-custom-config.yaml 
