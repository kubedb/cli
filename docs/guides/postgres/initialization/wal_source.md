...
Users can use supported cloud providers to replay existing  WAL files to restore a backed-up database. KubeDB currently supports *restoring from* [Amazon S3](/docs/guides/postgres/initialization/replay_from_s3.md), [Google Cloud Storage](/docs/guides/postgres/initialization/replay_from_gcs.md), [Azure Storage](/docs/guides/postgres/initialization/replay_from_azure.md), and [OpenStack Object Storage (Swift)](/docs/guides/postgres/initialization/replay_from_swift.md).
