...
A `Snapshot` is needed to be existed for this tutorial. Please follow the tutorial of [Snapshot](/docs/guides/mysql/snapshot/backup-and-restore.md) to create a database and take [Instant Snapshot/Backup](/docs/guides/mysql/snapshot/backup-and-restore.md#instant-backups)  of that database.
Assuming you have created a namespace `demo` and a snapshot `snap-mysql-infant`, below there is an illustration of initializing a database with `snap-mysql-infant` snapshot.
...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/0.8.0-beta.1/docs/examples/mysql/Initialization/demo-2.yaml
validating "https://raw.githubusercontent.com/kubedb/cli/0.8.0-beta.1/docs/examples/mysql/Initialization/demo-2.yaml"
