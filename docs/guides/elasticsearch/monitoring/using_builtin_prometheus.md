...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/elasticsearch-docs/docs/examples/elasticsearch/monitoring/builtin-prom-es.yaml
validating "https://raw.githubusercontent.com/kubedb/cli/elasticsearch-docs/docs/examples/elasticsearch/monitoring/builtin-prom-es.yaml"
...
```console
$ kubectl create -f https://raw.githubusercontent.com/kubedb/cli/elasticsearch-docs/docs/examples/monitoring/builtin-prometheus/demo-1.yaml
...
```console
$ kubectl create -f https://raw.githubusercontent.com/kubedb/cli/elasticsearch-docs/docs/examples/monitoring/builtin-prometheus/rbac/demo-2.yaml
...
```console
$ kubectl create -f https://raw.githubusercontent.com/kubedb/cli/elasticsearch-docs/docs/examples/monitoring/builtin-prometheus/demo-2.yaml
deployment "prometheus-server" created
service "prometheus-service" created
```
