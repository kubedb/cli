...
libbuild.REPO_ROOT = expandvars('$GOPATH') + '/src/github.com/appscode/container-datastore'
...
def fmt():
    libbuild.ungroup_go_imports('cmd')
    die(call('goimports -w cmd'))
    call('gofmt -s -w cmd')
...
def install():
    die(call('GO15VENDOREXPERIMENT=1 go install ./cmd/...'))
