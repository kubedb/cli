...
// MSSQLServerArchiversGetter has a method to return a MSSQLServerArchiverInterface.
...
// mSSQLServerArchivers implements MSSQLServerArchiverInterface
type mSSQLServerArchivers struct {
	client rest.Interface
	ns     string
}

// newMSSQLServerArchivers returns a MSSQLServerArchivers
func newMSSQLServerArchivers(c *ArchiverV1alpha1Client, namespace string) *mSSQLServerArchivers {
	return &mSSQLServerArchivers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *mSSQLServerArchivers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MSSQLServerArchiver, err error) {
	result = &v1alpha1.MSSQLServerArchiver{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mssqlserverarchivers").
		Name(name).
...
func (c *mSSQLServerArchivers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MSSQLServerArchiverList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MSSQLServerArchiverList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mssqlserverarchivers").
...
func (c *mSSQLServerArchivers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mSSQLServerArchivers) Create(ctx context.Context, mSSQLServerArchiver *v1alpha1.MSSQLServerArchiver, opts v1.CreateOptions) (result *v1alpha1.MSSQLServerArchiver, err error) {
	result = &v1alpha1.MSSQLServerArchiver{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mssqlserverarchivers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mSSQLServerArchiver).
		Do(ctx).
		Into(result)
	return
}
...
func (c *mSSQLServerArchivers) Update(ctx context.Context, mSSQLServerArchiver *v1alpha1.MSSQLServerArchiver, opts v1.UpdateOptions) (result *v1alpha1.MSSQLServerArchiver, err error) {
	result = &v1alpha1.MSSQLServerArchiver{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mssqlserverarchivers").
		Name(mSSQLServerArchiver.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mSSQLServerArchiver).
		Do(ctx).
		Into(result)
...
func (c *mSSQLServerArchivers) UpdateStatus(ctx context.Context, mSSQLServerArchiver *v1alpha1.MSSQLServerArchiver, opts v1.UpdateOptions) (result *v1alpha1.MSSQLServerArchiver, err error) {
	result = &v1alpha1.MSSQLServerArchiver{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mssqlserverarchivers").
...
func (c *mSSQLServerArchivers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mSSQLServerArchivers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mSSQLServerArchivers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MSSQLServerArchiver, err error) {
	result = &v1alpha1.MSSQLServerArchiver{}
