...
func newMongoDBs(c *GitopsV1alpha1Client, namespace string) *mongoDBs {
	return &mongoDBs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mongoDBs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoDB, err error) {
...
func (c *mongoDBs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoDBList, err error) {
...
func (c *mongoDBs) Create(ctx context.Context, mongoDB *v1alpha1.MongoDB, opts v1.CreateOptions) (result *v1alpha1.MongoDB, err error) {
	result = &v1alpha1.MongoDB{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) Update(ctx context.Context, mongoDB *v1alpha1.MongoDB, opts v1.UpdateOptions) (result *v1alpha1.MongoDB, err error) {
	result = &v1alpha1.MongoDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) UpdateStatus(ctx context.Context, mongoDB *v1alpha1.MongoDB, opts v1.UpdateOptions) (result *v1alpha1.MongoDB, err error) {
	result = &v1alpha1.MongoDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbs").
...
func (c *mongoDBs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoDB, err error) {
	result = &v1alpha1.MongoDB{}
