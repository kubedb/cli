...
func (c *postgresOpsRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PostgresOpsRequest, err error) {
	result = &v1alpha1.PostgresOpsRequest{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("postgresopsrequests").
		Name(name).
...
func (c *postgresOpsRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PostgresOpsRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PostgresOpsRequestList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("postgresopsrequests").
...
func (c *postgresOpsRequests) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *postgresOpsRequests) Create(ctx context.Context, postgresOpsRequest *v1alpha1.PostgresOpsRequest, opts v1.CreateOptions) (result *v1alpha1.PostgresOpsRequest, err error) {
	result = &v1alpha1.PostgresOpsRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("postgresopsrequests").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(postgresOpsRequest).
		Do(ctx).
		Into(result)
	return
}
...
func (c *postgresOpsRequests) Update(ctx context.Context, postgresOpsRequest *v1alpha1.PostgresOpsRequest, opts v1.UpdateOptions) (result *v1alpha1.PostgresOpsRequest, err error) {
	result = &v1alpha1.PostgresOpsRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresopsrequests").
		Name(postgresOpsRequest.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(postgresOpsRequest).
		Do(ctx).
		Into(result)
...
func (c *postgresOpsRequests) UpdateStatus(ctx context.Context, postgresOpsRequest *v1alpha1.PostgresOpsRequest, opts v1.UpdateOptions) (result *v1alpha1.PostgresOpsRequest, err error) {
	result = &v1alpha1.PostgresOpsRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresopsrequests").
...
func (c *postgresOpsRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *postgresOpsRequests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *postgresOpsRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PostgresOpsRequest, err error) {
	result = &v1alpha1.PostgresOpsRequest{}
