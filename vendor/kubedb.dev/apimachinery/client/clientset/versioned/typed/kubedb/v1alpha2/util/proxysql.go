...
func CreateOrPatchProxySQL(ctx context.Context, c cs.KubedbV1alpha2Interface, meta metav1.ObjectMeta, transform func(*api.ProxySQL) *api.ProxySQL, opts metav1.PatchOptions) (*api.ProxySQL, kutil.VerbType, error) {
...
func PatchProxySQL(ctx context.Context, c cs.KubedbV1alpha2Interface, cur *api.ProxySQL, transform func(*api.ProxySQL) *api.ProxySQL, opts metav1.PatchOptions) (*api.ProxySQL, kutil.VerbType, error) {
	return PatchProxySQLObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchProxySQLObject(ctx context.Context, c cs.KubedbV1alpha2Interface, cur, mod *api.ProxySQL, opts metav1.PatchOptions) (*api.ProxySQL, kutil.VerbType, error) {
