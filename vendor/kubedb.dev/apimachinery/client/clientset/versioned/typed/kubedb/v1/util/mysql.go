...
func CreateOrPatchMySQL(ctx context.Context, c cs.KubedbV1Interface, meta metav1.ObjectMeta, transform func(*api.MySQL) *api.MySQL, opts metav1.PatchOptions) (*api.MySQL, kutil.VerbType, error) {
...
func PatchMySQL(ctx context.Context, c cs.KubedbV1Interface, cur *api.MySQL, transform func(*api.MySQL) *api.MySQL, opts metav1.PatchOptions) (*api.MySQL, kutil.VerbType, error) {
	return PatchMySQLObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchMySQLObject(ctx context.Context, c cs.KubedbV1Interface, cur, mod *api.MySQL, opts metav1.PatchOptions) (*api.MySQL, kutil.VerbType, error) {
...
func TryUpdateMySQL(ctx context.Context, c cs.KubedbV1Interface, meta metav1.ObjectMeta, transform func(*api.MySQL) *api.MySQL, opts metav1.UpdateOptions) (result *api.MySQL, err error) {
	attempt := 0
