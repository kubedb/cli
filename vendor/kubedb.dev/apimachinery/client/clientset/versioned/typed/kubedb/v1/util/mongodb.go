...
func CreateOrPatchMongoDB(ctx context.Context, c cs.KubedbV1Interface, meta metav1.ObjectMeta, transform func(*api.MongoDB) *api.MongoDB, opts metav1.PatchOptions) (*api.MongoDB, kutil.VerbType, error) {
...
func PatchMongoDB(ctx context.Context, c cs.KubedbV1Interface, cur *api.MongoDB, transform func(*api.MongoDB) *api.MongoDB, opts metav1.PatchOptions) (*api.MongoDB, kutil.VerbType, error) {
	return PatchMongoDBObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchMongoDBObject(ctx context.Context, c cs.KubedbV1Interface, cur, mod *api.MongoDB, opts metav1.PatchOptions) (*api.MongoDB, kutil.VerbType, error) {
...
func TryUpdateMongoDB(ctx context.Context, c cs.KubedbV1Interface, meta metav1.ObjectMeta, transform func(*api.MongoDB) *api.MongoDB, opts metav1.UpdateOptions) (result *api.MongoDB, err error) {
	attempt := 0
