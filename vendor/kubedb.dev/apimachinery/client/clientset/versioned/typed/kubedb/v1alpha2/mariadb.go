...
type MariaDBInterface interface {
	Create(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.CreateOptions) (*v1alpha2.MariaDB, error)
	Update(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.UpdateOptions) (*v1alpha2.MariaDB, error)
	UpdateStatus(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.UpdateOptions) (*v1alpha2.MariaDB, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.MariaDB, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.MariaDBList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MariaDB, err error)
	MariaDBExpansion
}
...
func newMariaDBs(c *KubedbV1alpha2Client, namespace string) *mariaDBs {
	return &mariaDBs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mariaDBs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.MariaDB, err error) {
	result = &v1alpha2.MariaDB{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mariadbs").
		Name(name).
...
func (c *mariaDBs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.MariaDBList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.MariaDBList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mariadbs").
...
func (c *mariaDBs) Create(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.CreateOptions) (result *v1alpha2.MariaDB, err error) {
	result = &v1alpha2.MariaDB{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mariadbs").
...
func (c *mariaDBs) Update(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.UpdateOptions) (result *v1alpha2.MariaDB, err error) {
	result = &v1alpha2.MariaDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbs").
...
func (c *mariaDBs) UpdateStatus(ctx context.Context, mariaDB *v1alpha2.MariaDB, opts v1.UpdateOptions) (result *v1alpha2.MariaDB, err error) {
	result = &v1alpha2.MariaDB{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbs").
...
func (c *mariaDBs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MariaDB, err error) {
	result = &v1alpha2.MariaDB{}
