...
func CreateOrPatchMemcached(ctx context.Context, c cs.KubedbV1alpha2Interface, meta metav1.ObjectMeta, transform func(*api.Memcached) *api.Memcached, opts metav1.PatchOptions) (*api.Memcached, kutil.VerbType, error) {
...
func PatchMemcached(ctx context.Context, c cs.KubedbV1alpha2Interface, cur *api.Memcached, transform func(*api.Memcached) *api.Memcached, opts metav1.PatchOptions) (*api.Memcached, kutil.VerbType, error) {
	return PatchMemcachedObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchMemcachedObject(ctx context.Context, c cs.KubedbV1alpha2Interface, cur, mod *api.Memcached, opts metav1.PatchOptions) (*api.Memcached, kutil.VerbType, error) {
