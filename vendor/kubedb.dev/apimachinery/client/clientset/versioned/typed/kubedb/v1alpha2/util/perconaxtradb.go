...
func CreateOrPatchPerconaXtraDB(ctx context.Context, c cs.KubedbV1alpha2Interface, meta metav1.ObjectMeta, transform func(*api.PerconaXtraDB) *api.PerconaXtraDB, opts metav1.PatchOptions) (*api.PerconaXtraDB, kutil.VerbType, error) {
...
func PatchPerconaXtraDB(ctx context.Context, c cs.KubedbV1alpha2Interface, cur *api.PerconaXtraDB, transform func(*api.PerconaXtraDB) *api.PerconaXtraDB, opts metav1.PatchOptions) (*api.PerconaXtraDB, kutil.VerbType, error) {
	return PatchPerconaXtraDBObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchPerconaXtraDBObject(ctx context.Context, c cs.KubedbV1alpha2Interface, cur, mod *api.PerconaXtraDB, opts metav1.PatchOptions) (*api.PerconaXtraDB, kutil.VerbType, error) {
