...
func (c *druidVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DruidVersion, err error) {
	result = &v1alpha1.DruidVersion{}
	err = c.client.Get().
		Resource("druidversions").
		Name(name).
...
func (c *druidVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DruidVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DruidVersionList{}
	err = c.client.Get().
		Resource("druidversions").
...
func (c *druidVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *druidVersions) Create(ctx context.Context, druidVersion *v1alpha1.DruidVersion, opts v1.CreateOptions) (result *v1alpha1.DruidVersion, err error) {
	result = &v1alpha1.DruidVersion{}
	err = c.client.Post().
		Resource("druidversions").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *druidVersions) Update(ctx context.Context, druidVersion *v1alpha1.DruidVersion, opts v1.UpdateOptions) (result *v1alpha1.DruidVersion, err error) {
	result = &v1alpha1.DruidVersion{}
	err = c.client.Put().
		Resource("druidversions").
		Name(druidVersion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(druidVersion).
		Do(ctx).
		Into(result)
...
func (c *druidVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *druidVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *druidVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DruidVersion, err error) {
	result = &v1alpha1.DruidVersion{}
