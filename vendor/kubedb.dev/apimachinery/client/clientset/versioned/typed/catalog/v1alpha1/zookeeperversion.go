...
func (c *zooKeeperVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ZooKeeperVersion, err error) {
	result = &v1alpha1.ZooKeeperVersion{}
	err = c.client.Get().
		Resource("zookeeperversions").
		Name(name).
...
func (c *zooKeeperVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ZooKeeperVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ZooKeeperVersionList{}
	err = c.client.Get().
		Resource("zookeeperversions").
...
func (c *zooKeeperVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *zooKeeperVersions) Create(ctx context.Context, zooKeeperVersion *v1alpha1.ZooKeeperVersion, opts v1.CreateOptions) (result *v1alpha1.ZooKeeperVersion, err error) {
	result = &v1alpha1.ZooKeeperVersion{}
	err = c.client.Post().
		Resource("zookeeperversions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(zooKeeperVersion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *zooKeeperVersions) Update(ctx context.Context, zooKeeperVersion *v1alpha1.ZooKeeperVersion, opts v1.UpdateOptions) (result *v1alpha1.ZooKeeperVersion, err error) {
	result = &v1alpha1.ZooKeeperVersion{}
	err = c.client.Put().
		Resource("zookeeperversions").
		Name(zooKeeperVersion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(zooKeeperVersion).
		Do(ctx).
		Into(result)
...
func (c *zooKeeperVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *zooKeeperVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *zooKeeperVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ZooKeeperVersion, err error) {
	result = &v1alpha1.ZooKeeperVersion{}
