...
func (c *postgresVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PostgresVersion, err error) {
...
func (c *postgresVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PostgresVersionList, err error) {
...
func (c *postgresVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *postgresVersions) Create(ctx context.Context, postgresVersion *v1alpha1.PostgresVersion, opts v1.CreateOptions) (result *v1alpha1.PostgresVersion, err error) {
	result = &v1alpha1.PostgresVersion{}
	err = c.client.Post().
		Resource("postgresversions").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *postgresVersions) Update(ctx context.Context, postgresVersion *v1alpha1.PostgresVersion, opts v1.UpdateOptions) (result *v1alpha1.PostgresVersion, err error) {
	result = &v1alpha1.PostgresVersion{}
	err = c.client.Put().
		Resource("postgresversions").
...
func (c *postgresVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *postgresVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *postgresVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PostgresVersion, err error) {
	result = &v1alpha1.PostgresVersion{}
