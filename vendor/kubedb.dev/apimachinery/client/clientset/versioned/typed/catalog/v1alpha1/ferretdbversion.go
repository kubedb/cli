...
// FerretDBVersionsGetter has a method to return a FerretDBVersionInterface.
...
// ferretDBVersions implements FerretDBVersionInterface
type ferretDBVersions struct {
	client rest.Interface
}

// newFerretDBVersions returns a FerretDBVersions
func newFerretDBVersions(c *CatalogV1alpha1Client) *ferretDBVersions {
	return &ferretDBVersions{
		client: c.RESTClient(),
	}
}

// Get takes name of the ferretDBVersion, and returns the corresponding ferretDBVersion object, and an error if there is any.
func (c *ferretDBVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FerretDBVersion, err error) {
	result = &v1alpha1.FerretDBVersion{}
	err = c.client.Get().
		Resource("ferretdbversions").
		Name(name).
...
func (c *ferretDBVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FerretDBVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FerretDBVersionList{}
	err = c.client.Get().
		Resource("ferretdbversions").
...
func (c *ferretDBVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ferretDBVersions) Create(ctx context.Context, ferretDBVersion *v1alpha1.FerretDBVersion, opts v1.CreateOptions) (result *v1alpha1.FerretDBVersion, err error) {
	result = &v1alpha1.FerretDBVersion{}
	err = c.client.Post().
		Resource("ferretdbversions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ferretDBVersion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ferretDBVersions) Update(ctx context.Context, ferretDBVersion *v1alpha1.FerretDBVersion, opts v1.UpdateOptions) (result *v1alpha1.FerretDBVersion, err error) {
	result = &v1alpha1.FerretDBVersion{}
	err = c.client.Put().
		Resource("ferretdbversions").
		Name(ferretDBVersion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ferretDBVersion).
		Do(ctx).
		Into(result)
...
func (c *ferretDBVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ferretDBVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ferretDBVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FerretDBVersion, err error) {
	result = &v1alpha1.FerretDBVersion{}
