...
type KafkaV1alpha1Interface interface {
...
func (c *KafkaV1alpha1Client) ConnectClusters(namespace string) ConnectClusterInterface {
	return newConnectClusters(c, namespace)
}
...
// NewForConfigAndClient creates a new KafkaV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KafkaV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &KafkaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KafkaV1alpha1Client for the given config and
