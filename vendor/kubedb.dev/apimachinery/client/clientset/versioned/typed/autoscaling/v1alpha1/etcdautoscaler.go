...
func (c *etcdAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EtcdAutoscaler, err error) {
	result = &v1alpha1.EtcdAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("etcdautoscalers").
		Name(name).
...
func (c *etcdAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EtcdAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EtcdAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("etcdautoscalers").
...
func (c *etcdAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *etcdAutoscalers) Create(ctx context.Context, etcdAutoscaler *v1alpha1.EtcdAutoscaler, opts v1.CreateOptions) (result *v1alpha1.EtcdAutoscaler, err error) {
	result = &v1alpha1.EtcdAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("etcdautoscalers").
...
func (c *etcdAutoscalers) Update(ctx context.Context, etcdAutoscaler *v1alpha1.EtcdAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.EtcdAutoscaler, err error) {
	result = &v1alpha1.EtcdAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdautoscalers").
		Name(etcdAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(etcdAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *etcdAutoscalers) UpdateStatus(ctx context.Context, etcdAutoscaler *v1alpha1.EtcdAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.EtcdAutoscaler, err error) {
	result = &v1alpha1.EtcdAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdautoscalers").
...
func (c *etcdAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *etcdAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *etcdAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EtcdAutoscaler, err error) {
	result = &v1alpha1.EtcdAutoscaler{}
