...
func (c *postgresAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PostgresAutoscaler, err error) {
	result = &v1alpha1.PostgresAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("postgresautoscalers").
		Name(name).
...
func (c *postgresAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PostgresAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PostgresAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("postgresautoscalers").
...
func (c *postgresAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *postgresAutoscalers) Create(ctx context.Context, postgresAutoscaler *v1alpha1.PostgresAutoscaler, opts v1.CreateOptions) (result *v1alpha1.PostgresAutoscaler, err error) {
	result = &v1alpha1.PostgresAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("postgresautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(postgresAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *postgresAutoscalers) Update(ctx context.Context, postgresAutoscaler *v1alpha1.PostgresAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PostgresAutoscaler, err error) {
	result = &v1alpha1.PostgresAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresautoscalers").
		Name(postgresAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(postgresAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *postgresAutoscalers) UpdateStatus(ctx context.Context, postgresAutoscaler *v1alpha1.PostgresAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PostgresAutoscaler, err error) {
	result = &v1alpha1.PostgresAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresautoscalers").
...
func (c *postgresAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *postgresAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *postgresAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PostgresAutoscaler, err error) {
	result = &v1alpha1.PostgresAutoscaler{}
