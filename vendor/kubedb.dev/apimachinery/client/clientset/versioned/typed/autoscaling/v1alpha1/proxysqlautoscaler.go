...
func (c *proxySQLAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProxySQLAutoscaler, err error) {
	result = &v1alpha1.ProxySQLAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("proxysqlautoscalers").
		Name(name).
...
func (c *proxySQLAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProxySQLAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProxySQLAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("proxysqlautoscalers").
...
func (c *proxySQLAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *proxySQLAutoscalers) Create(ctx context.Context, proxySQLAutoscaler *v1alpha1.ProxySQLAutoscaler, opts v1.CreateOptions) (result *v1alpha1.ProxySQLAutoscaler, err error) {
	result = &v1alpha1.ProxySQLAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("proxysqlautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(proxySQLAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *proxySQLAutoscalers) Update(ctx context.Context, proxySQLAutoscaler *v1alpha1.ProxySQLAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.ProxySQLAutoscaler, err error) {
	result = &v1alpha1.ProxySQLAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("proxysqlautoscalers").
		Name(proxySQLAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(proxySQLAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *proxySQLAutoscalers) UpdateStatus(ctx context.Context, proxySQLAutoscaler *v1alpha1.ProxySQLAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.ProxySQLAutoscaler, err error) {
	result = &v1alpha1.ProxySQLAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("proxysqlautoscalers").
...
func (c *proxySQLAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *proxySQLAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *proxySQLAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProxySQLAutoscaler, err error) {
	result = &v1alpha1.ProxySQLAutoscaler{}
