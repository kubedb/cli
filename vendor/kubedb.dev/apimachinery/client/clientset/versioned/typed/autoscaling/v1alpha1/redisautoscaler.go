...
func (c *redisAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedisAutoscaler, err error) {
	result = &v1alpha1.RedisAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redisautoscalers").
		Name(name).
...
func (c *redisAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedisAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RedisAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redisautoscalers").
...
func (c *redisAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redisAutoscalers) Create(ctx context.Context, redisAutoscaler *v1alpha1.RedisAutoscaler, opts v1.CreateOptions) (result *v1alpha1.RedisAutoscaler, err error) {
	result = &v1alpha1.RedisAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redisautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(redisAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *redisAutoscalers) Update(ctx context.Context, redisAutoscaler *v1alpha1.RedisAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.RedisAutoscaler, err error) {
	result = &v1alpha1.RedisAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisautoscalers").
		Name(redisAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(redisAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *redisAutoscalers) UpdateStatus(ctx context.Context, redisAutoscaler *v1alpha1.RedisAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.RedisAutoscaler, err error) {
	result = &v1alpha1.RedisAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisautoscalers").
...
func (c *redisAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *redisAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *redisAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedisAutoscaler, err error) {
	result = &v1alpha1.RedisAutoscaler{}
