...
func (c *clickHouseAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClickHouseAutoscaler, err error) {
	result = &v1alpha1.ClickHouseAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clickhouseautoscalers").
		Name(name).
...
func (c *clickHouseAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClickHouseAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClickHouseAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clickhouseautoscalers").
...
func (c *clickHouseAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clickHouseAutoscalers) Create(ctx context.Context, clickHouseAutoscaler *v1alpha1.ClickHouseAutoscaler, opts v1.CreateOptions) (result *v1alpha1.ClickHouseAutoscaler, err error) {
	result = &v1alpha1.ClickHouseAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clickhouseautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clickHouseAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clickHouseAutoscalers) Update(ctx context.Context, clickHouseAutoscaler *v1alpha1.ClickHouseAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.ClickHouseAutoscaler, err error) {
	result = &v1alpha1.ClickHouseAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clickhouseautoscalers").
		Name(clickHouseAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clickHouseAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *clickHouseAutoscalers) UpdateStatus(ctx context.Context, clickHouseAutoscaler *v1alpha1.ClickHouseAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.ClickHouseAutoscaler, err error) {
	result = &v1alpha1.ClickHouseAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clickhouseautoscalers").
...
func (c *clickHouseAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clickHouseAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clickHouseAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClickHouseAutoscaler, err error) {
	result = &v1alpha1.ClickHouseAutoscaler{}
