...
func (c *memcachedAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MemcachedAutoscaler, err error) {
	result = &v1alpha1.MemcachedAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("memcachedautoscalers").
		Name(name).
...
func (c *memcachedAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MemcachedAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MemcachedAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("memcachedautoscalers").
...
func (c *memcachedAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *memcachedAutoscalers) Create(ctx context.Context, memcachedAutoscaler *v1alpha1.MemcachedAutoscaler, opts v1.CreateOptions) (result *v1alpha1.MemcachedAutoscaler, err error) {
	result = &v1alpha1.MemcachedAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("memcachedautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(memcachedAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *memcachedAutoscalers) Update(ctx context.Context, memcachedAutoscaler *v1alpha1.MemcachedAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MemcachedAutoscaler, err error) {
	result = &v1alpha1.MemcachedAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("memcachedautoscalers").
		Name(memcachedAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(memcachedAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *memcachedAutoscalers) UpdateStatus(ctx context.Context, memcachedAutoscaler *v1alpha1.MemcachedAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MemcachedAutoscaler, err error) {
	result = &v1alpha1.MemcachedAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("memcachedautoscalers").
...
func (c *memcachedAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *memcachedAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *memcachedAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MemcachedAutoscaler, err error) {
	result = &v1alpha1.MemcachedAutoscaler{}
