...
// MongoDBAutoscalersGetter has a method to return a MongoDBAutoscalerInterface.
...
// mongoDBAutoscalers implements MongoDBAutoscalerInterface
type mongoDBAutoscalers struct {
	client rest.Interface
	ns     string
}

// newMongoDBAutoscalers returns a MongoDBAutoscalers
func newMongoDBAutoscalers(c *AutoscalingV1alpha1Client, namespace string) *mongoDBAutoscalers {
	return &mongoDBAutoscalers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *mongoDBAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoDBAutoscaler, err error) {
	result = &v1alpha1.MongoDBAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mongodbautoscalers").
		Name(name).
...
func (c *mongoDBAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoDBAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MongoDBAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mongodbautoscalers").
...
func (c *mongoDBAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mongoDBAutoscalers) Create(ctx context.Context, mongoDBAutoscaler *v1alpha1.MongoDBAutoscaler, opts v1.CreateOptions) (result *v1alpha1.MongoDBAutoscaler, err error) {
	result = &v1alpha1.MongoDBAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongodbautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mongoDBAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *mongoDBAutoscalers) Update(ctx context.Context, mongoDBAutoscaler *v1alpha1.MongoDBAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MongoDBAutoscaler, err error) {
	result = &v1alpha1.MongoDBAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbautoscalers").
		Name(mongoDBAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mongoDBAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *mongoDBAutoscalers) UpdateStatus(ctx context.Context, mongoDBAutoscaler *v1alpha1.MongoDBAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MongoDBAutoscaler, err error) {
	result = &v1alpha1.MongoDBAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbautoscalers").
...
func (c *mongoDBAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mongoDBAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mongoDBAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoDBAutoscaler, err error) {
	result = &v1alpha1.MongoDBAutoscaler{}
