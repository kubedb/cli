...
func (c *mariaDBAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MariaDBAutoscaler, err error) {
	result = &v1alpha1.MariaDBAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mariadbautoscalers").
		Name(name).
...
func (c *mariaDBAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MariaDBAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MariaDBAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mariadbautoscalers").
...
func (c *mariaDBAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mariaDBAutoscalers) Create(ctx context.Context, mariaDBAutoscaler *v1alpha1.MariaDBAutoscaler, opts v1.CreateOptions) (result *v1alpha1.MariaDBAutoscaler, err error) {
	result = &v1alpha1.MariaDBAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mariadbautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mariaDBAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *mariaDBAutoscalers) Update(ctx context.Context, mariaDBAutoscaler *v1alpha1.MariaDBAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MariaDBAutoscaler, err error) {
	result = &v1alpha1.MariaDBAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbautoscalers").
		Name(mariaDBAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mariaDBAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *mariaDBAutoscalers) UpdateStatus(ctx context.Context, mariaDBAutoscaler *v1alpha1.MariaDBAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MariaDBAutoscaler, err error) {
	result = &v1alpha1.MariaDBAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbautoscalers").
...
func (c *mariaDBAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mariaDBAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mariaDBAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MariaDBAutoscaler, err error) {
	result = &v1alpha1.MariaDBAutoscaler{}
