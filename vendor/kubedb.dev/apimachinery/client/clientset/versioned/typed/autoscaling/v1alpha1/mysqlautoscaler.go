...
func (c *mySQLAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MySQLAutoscaler, err error) {
	result = &v1alpha1.MySQLAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mysqlautoscalers").
		Name(name).
...
func (c *mySQLAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MySQLAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MySQLAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mysqlautoscalers").
...
func (c *mySQLAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mySQLAutoscalers) Create(ctx context.Context, mySQLAutoscaler *v1alpha1.MySQLAutoscaler, opts v1.CreateOptions) (result *v1alpha1.MySQLAutoscaler, err error) {
	result = &v1alpha1.MySQLAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mysqlautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mySQLAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *mySQLAutoscalers) Update(ctx context.Context, mySQLAutoscaler *v1alpha1.MySQLAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MySQLAutoscaler, err error) {
	result = &v1alpha1.MySQLAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlautoscalers").
		Name(mySQLAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mySQLAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *mySQLAutoscalers) UpdateStatus(ctx context.Context, mySQLAutoscaler *v1alpha1.MySQLAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.MySQLAutoscaler, err error) {
	result = &v1alpha1.MySQLAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlautoscalers").
...
func (c *mySQLAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mySQLAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mySQLAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MySQLAutoscaler, err error) {
	result = &v1alpha1.MySQLAutoscaler{}
