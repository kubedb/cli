...
// PgpoolAutoscalersGetter has a method to return a PgpoolAutoscalerInterface.
...
// pgpoolAutoscalers implements PgpoolAutoscalerInterface
type pgpoolAutoscalers struct {
	client rest.Interface
	ns     string
}

// newPgpoolAutoscalers returns a PgpoolAutoscalers
func newPgpoolAutoscalers(c *AutoscalingV1alpha1Client, namespace string) *pgpoolAutoscalers {
	return &pgpoolAutoscalers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *pgpoolAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PgpoolAutoscaler, err error) {
	result = &v1alpha1.PgpoolAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgpoolautoscalers").
		Name(name).
...
func (c *pgpoolAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PgpoolAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PgpoolAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgpoolautoscalers").
...
func (c *pgpoolAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pgpoolAutoscalers) Create(ctx context.Context, pgpoolAutoscaler *v1alpha1.PgpoolAutoscaler, opts v1.CreateOptions) (result *v1alpha1.PgpoolAutoscaler, err error) {
	result = &v1alpha1.PgpoolAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pgpoolautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pgpoolAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *pgpoolAutoscalers) Update(ctx context.Context, pgpoolAutoscaler *v1alpha1.PgpoolAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PgpoolAutoscaler, err error) {
	result = &v1alpha1.PgpoolAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgpoolautoscalers").
		Name(pgpoolAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pgpoolAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *pgpoolAutoscalers) UpdateStatus(ctx context.Context, pgpoolAutoscaler *v1alpha1.PgpoolAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PgpoolAutoscaler, err error) {
	result = &v1alpha1.PgpoolAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgpoolautoscalers").
...
func (c *pgpoolAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pgpoolAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pgpoolAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PgpoolAutoscaler, err error) {
	result = &v1alpha1.PgpoolAutoscaler{}
