...
// SolrAutoscalersGetter has a method to return a SolrAutoscalerInterface.
...
// solrAutoscalers implements SolrAutoscalerInterface
type solrAutoscalers struct {
	client rest.Interface
	ns     string
}

// newSolrAutoscalers returns a SolrAutoscalers
func newSolrAutoscalers(c *AutoscalingV1alpha1Client, namespace string) *solrAutoscalers {
	return &solrAutoscalers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *solrAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SolrAutoscaler, err error) {
	result = &v1alpha1.SolrAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("solrautoscalers").
		Name(name).
...
func (c *solrAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SolrAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SolrAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("solrautoscalers").
...
func (c *solrAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *solrAutoscalers) Create(ctx context.Context, solrAutoscaler *v1alpha1.SolrAutoscaler, opts v1.CreateOptions) (result *v1alpha1.SolrAutoscaler, err error) {
	result = &v1alpha1.SolrAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("solrautoscalers").
...
func (c *solrAutoscalers) Update(ctx context.Context, solrAutoscaler *v1alpha1.SolrAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.SolrAutoscaler, err error) {
	result = &v1alpha1.SolrAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("solrautoscalers").
		Name(solrAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(solrAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *solrAutoscalers) UpdateStatus(ctx context.Context, solrAutoscaler *v1alpha1.SolrAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.SolrAutoscaler, err error) {
	result = &v1alpha1.SolrAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("solrautoscalers").
...
func (c *solrAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *solrAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *solrAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SolrAutoscaler, err error) {
	result = &v1alpha1.SolrAutoscaler{}
