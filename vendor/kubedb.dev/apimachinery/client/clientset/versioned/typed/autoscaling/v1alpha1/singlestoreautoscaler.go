...
func (c *singlestoreAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SinglestoreAutoscaler, err error) {
	result = &v1alpha1.SinglestoreAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("singlestoreautoscalers").
		Name(name).
...
func (c *singlestoreAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SinglestoreAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SinglestoreAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("singlestoreautoscalers").
...
func (c *singlestoreAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *singlestoreAutoscalers) Create(ctx context.Context, singlestoreAutoscaler *v1alpha1.SinglestoreAutoscaler, opts v1.CreateOptions) (result *v1alpha1.SinglestoreAutoscaler, err error) {
	result = &v1alpha1.SinglestoreAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("singlestoreautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(singlestoreAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *singlestoreAutoscalers) Update(ctx context.Context, singlestoreAutoscaler *v1alpha1.SinglestoreAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.SinglestoreAutoscaler, err error) {
	result = &v1alpha1.SinglestoreAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("singlestoreautoscalers").
		Name(singlestoreAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(singlestoreAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *singlestoreAutoscalers) UpdateStatus(ctx context.Context, singlestoreAutoscaler *v1alpha1.SinglestoreAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.SinglestoreAutoscaler, err error) {
	result = &v1alpha1.SinglestoreAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("singlestoreautoscalers").
...
func (c *singlestoreAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *singlestoreAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *singlestoreAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SinglestoreAutoscaler, err error) {
	result = &v1alpha1.SinglestoreAutoscaler{}
