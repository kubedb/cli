...
func (c *pgBouncerAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PgBouncerAutoscaler, err error) {
	result = &v1alpha1.PgBouncerAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgbouncerautoscalers").
		Name(name).
...
func (c *pgBouncerAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PgBouncerAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PgBouncerAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pgbouncerautoscalers").
...
func (c *pgBouncerAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pgBouncerAutoscalers) Create(ctx context.Context, pgBouncerAutoscaler *v1alpha1.PgBouncerAutoscaler, opts v1.CreateOptions) (result *v1alpha1.PgBouncerAutoscaler, err error) {
	result = &v1alpha1.PgBouncerAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pgbouncerautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pgBouncerAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *pgBouncerAutoscalers) Update(ctx context.Context, pgBouncerAutoscaler *v1alpha1.PgBouncerAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PgBouncerAutoscaler, err error) {
	result = &v1alpha1.PgBouncerAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgbouncerautoscalers").
		Name(pgBouncerAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pgBouncerAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *pgBouncerAutoscalers) UpdateStatus(ctx context.Context, pgBouncerAutoscaler *v1alpha1.PgBouncerAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.PgBouncerAutoscaler, err error) {
	result = &v1alpha1.PgBouncerAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pgbouncerautoscalers").
...
func (c *pgBouncerAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pgBouncerAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pgBouncerAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PgBouncerAutoscaler, err error) {
	result = &v1alpha1.PgBouncerAutoscaler{}
