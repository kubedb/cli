...
// Qdrant is the Schema for the qdrants API.
...
type Qdrant struct {
	...
	Spec   dbv1a2.QdrantSpec `json:"spec,omitempty"`
	Status QdrantStatus      `json:"status,omitempty"`
}

type QdrantStatus struct {
	dbv1a2.QdrantStatus `json:",inline"`
...
func init() {
	SchemeBuilder.Register(&Qdrant{}, &QdrantList{})
}
