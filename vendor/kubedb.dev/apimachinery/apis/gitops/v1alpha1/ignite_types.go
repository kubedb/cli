...
// Ignite is the Schema for the ignites API.
...
type Ignite struct {
	...
	Spec   dbv1a2.IgniteSpec `json:"spec,omitempty"`
	Status IgniteStatus      `json:"status,omitempty"`
}

type IgniteStatus struct {
	dbv1a2.IgniteStatus `json:",inline"`
...
func init() {
	SchemeBuilder.Register(&Ignite{}, &IgniteList{})
}
