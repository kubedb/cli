...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradeConstraints) DeepCopyInto(out *UpgradeConstraints) {
	*out = *in
	if in.Allowlist != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradeConstraints.
func (in *UpgradeConstraints) DeepCopy() *UpgradeConstraints {
	if in == nil {
		return nil
	}
	out := new(UpgradeConstraints)
	in.DeepCopyInto(out)
	return out
}
