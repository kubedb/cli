...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboardStatus": schema_apimachinery_apis_dashboard_v1alpha1_ElasticsearchDashboardStatus(ref),
	}
}
...
func schema_apimachinery_apis_dashboard_v1alpha1_ElasticsearchDashboard(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboardSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboardStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboardSpec", "kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboardStatus"},
	}
}

func schema_apimachinery_apis_dashboard_v1alpha1_ElasticsearchDashboardList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboard"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubedb.dev/apimachinery/apis/dashboard/v1alpha1.ElasticsearchDashboard"},
	}
}

func schema_apimachinery_apis_dashboard_v1alpha1_ElasticsearchDashboardSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"configSecret": {
						SchemaProps: spec.SchemaProps{
							Description: "ConfigSecret is an optional field to provide custom configuration file for dashboard. If specified, this file will be used as configuration file otherwise default configuration file will be used.",
							Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
						},
					},
					"podTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "PodTemplate is an optional configuration for pods used to expose Dashboard",
							Default:     map[string]interface{}{},
					...
					"serviceTemplates": {
						SchemaProps: spec.SchemaProps{
							Description: "ServiceTemplates is an optional configuration for services used to expose Dashboard",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_apimachinery_apis_dashboard_v1alpha1_ElasticsearchDashboardStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ElasticsearchDashboardStatus defines the observed state of ElasticsearchDashboard",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
