...
func (r *RabbitMQOpsRequest) CustomResourceDefinition() *apiextensions.CustomResourceDefinition {
	return crds.MustCustomResourceDefinition(SchemeGroupVersion.WithResource(ResourcePluralRabbitMQOpsRequest))
}

var _ apis.ResourceInfo = &RabbitMQOpsRequest{}

func (r *RabbitMQOpsRequest) ResourceFQN() string {
	return fmt.Sprintf("%s.%s", ResourcePluralRabbitMQOpsRequest, ops.GroupName)
}

func (r *RabbitMQOpsRequest) ResourceShortCode() string {
	return ResourceCodeRabbitMQOpsRequest
}

func (r *RabbitMQOpsRequest) ResourceKind() string {
	return ResourceKindRabbitMQOpsRequest
}

func (r *RabbitMQOpsRequest) ResourceSingular() string {
	return ResourceSingularRabbitMQOpsRequest
}

func (r *RabbitMQOpsRequest) ResourcePlural() string {
	return ResourcePluralRabbitMQOpsRequest
}

var _ Accessor = &RabbitMQOpsRequest{}
