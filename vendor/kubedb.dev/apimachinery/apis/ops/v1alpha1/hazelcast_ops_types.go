...
type HazelcastOpsRequestSpec struct {
	...
	Configuration *HazelcastCustomConfigurationSpec `json:"configuration,omitempty"`
...
type HazelcastCustomConfigurationSpec struct {
	// ConfigSecret is an optional field to provide custom configuration file for database.
	// +optional
	ConfigSecret *core.LocalObjectReference `json:"configSecret,omitempty"`
	// ApplyConfig is an optional field to provide hazelcast configuration.
	...
	// The hazelcast cluster will start will default configuration that is generated by the operator.
	// +optional
