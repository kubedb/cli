...
const (
	ResourceCodeVerticalAutoscaler     = "vascaler"
	ResourceKindVerticalAutoscaler     = "VerticalAutoscaler"
	ResourceSingularVerticalAutoscaler = "verticalautoscaler"
	ResourcePluralVerticalAutoscaler   = "verticalautoscalers"
)

// VerticalAutoscaler is the configuration for a vertical pod
...
type VerticalAutoscaler struct {
	...
	Spec VerticalAutoscalerSpec `json:"spec" protobuf:"bytes,2,name=spec"`

	// Current information about the autoscaler.
	// +optional
	Status VerticalAutoscalerStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

// VerticalAutoscalerSpec is the specification of the behavior of the autoscaler.
type VerticalAutoscalerSpec struct {
	...
	// the target resource.
	TargetRef *core.TypedLocalObjectReference `json:"targetRef" protobuf:"bytes,1,name=targetRef"`
...
const (
	...
	// VerticalAutoscaler object. This can be used for a "dry run".
...
type ContainerResourcePolicy struct {
	...
	// +optional
	Mode *ContainerScalingMode `json:"mode,omitempty" protobuf:"bytes,2,opt,name=mode,casttype=ContainerScalingMode"`
	// Specifies the minimal amount of resources that will be recommended
	// for the container. The default is no minimum.
	// +optional
	MinAllowed core.ResourceList `json:"minAllowed,omitempty" protobuf:"bytes,3,rep,name=minAllowed,casttype=k8s.io/api/core/v1.ResourceList,castkey=k8s.io/api/core/v1.ResourceName"`
	// Specifies the maximum amount of resources that will be recommended
	// for the container. The default is no maximum.
	// +optional
	MaxAllowed core.ResourceList `json:"maxAllowed,omitempty" protobuf:"bytes,4,rep,name=maxAllowed,casttype=k8s.io/api/core/v1.ResourceList,castkey=k8s.io/api/core/v1.ResourceName"`
	...
	// +optional
	ControlledValues *ContainerControlledValues `json:"controlledValues,omitempty" protobuf:"bytes,6,opt,name=controlledValues,casttype=ContainerControlledValues"`
}
...
type VerticalAutoscalerStatus struct {
...
type RecommendedContainerResources struct {
	...
	Target core.ResourceList `json:"target" protobuf:"bytes,2,rep,name=target,casttype=ResourceList,castkey=ResourceName"`
	...
	// +optional
	LowerBound core.ResourceList `json:"lowerBound,omitempty" protobuf:"bytes,3,rep,name=lowerBound,casttype=ResourceList,castkey=ResourceName"`
	...
	// +optional
	UpperBound core.ResourceList `json:"upperBound,omitempty" protobuf:"bytes,4,rep,name=upperBound,casttype=ResourceList,castkey=ResourceName"`
	...
	// +optional
	UncappedTarget core.ResourceList `json:"uncappedTarget,omitempty" protobuf:"bytes,5,opt,name=uncappedTarget"`
}

// VerticalAutoscalerConditionType are the valid conditions of
// a VerticalAutoscaler.
...
// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
type VerticalAutoscalerCheckpoint struct {
	metav1.TypeMeta `json:",inline"`
	// Standard object metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
	// +optional
	metav1.ObjectMeta `json:"metadata,omitempty" protobuf:"bytes,1,opt,name=metadata"`
	...
	// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.
	// +optional
	Spec VerticalAutoscalerCheckpointSpec `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`

	// Data of the checkpoint.
	// +optional
	Status VerticalAutoscalerCheckpointStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// VerticalAutoscalerCheckpointList is a list of VerticalAutoscalerCheckpoint objects.
type VerticalAutoscalerCheckpointList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata" protobuf:"bytes,1,opt,name=metadata"`
	Items           []VerticalAutoscalerCheckpoint `json:"items" protobuf:"bytes,2,rep,name=items"`
}
...
type VerticalAutoscalerCheckpointStatus struct {
	...
	TotalSamplesCount int64 `json:"totalSamplesCount,omitempty" protobuf:"bytes,7,opt,name=totalSamplesCount"`
}
...
type HistogramCheckpoint struct {
	...
	BucketWeights map[json.Number]uint32 `json:"bucketWeights,omitempty" protobuf:"bytes,2,opt,name=bucketWeights"`
...
type VerticalAutoscalerList struct {
	metav1.TypeMeta `json:",inline"`
	...
	Items []VerticalAutoscaler `json:"items" protobuf:"bytes,2,rep,name=items"`
}
