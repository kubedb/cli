...
func (r MSSQLServerAutoscaler) CustomResourceDefinition() *apiextensions.CustomResourceDefinition {
	return crds.MustCustomResourceDefinition(SchemeGroupVersion.WithResource(ResourcePluralMSSQLServerAutoscaler))
}

var _ apis.ResourceInfo = &MSSQLServerAutoscaler{}

func (r MSSQLServerAutoscaler) ResourceFQN() string {
	return fmt.Sprintf("%s.%s", ResourcePluralMSSQLServerAutoscaler, autoscaling.GroupName)
}

func (r MSSQLServerAutoscaler) ResourceShortCode() string {
	return ResourceCodeMSSQLServerAutoscaler
}

func (r MSSQLServerAutoscaler) ResourceKind() string {
	return ResourceKindMSSQLServerAutoscaler
}

func (r MSSQLServerAutoscaler) ResourceSingular() string {
	return ResourceSingularMSSQLServerAutoscaler
}

func (r MSSQLServerAutoscaler) ResourcePlural() string {
	return ResourcePluralMSSQLServerAutoscaler
}
...
var _ StatusAccessor = &MSSQLServerAutoscaler{}
