...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*v1alpha2.MongoDBConfigNode)(nil), (*MongoDBConfigNode)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha2.MongoDBShardNode)(nil), (*MongoDBShardNode)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha2.MySQLTopology)(nil), (*MySQLTopology)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha2.ScriptSourceSpec)(nil), (*ScriptSourceSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha2_ElasticsearchNode_To_v1alpha1_ElasticsearchNode(in *v1alpha2.ElasticsearchNode, out *ElasticsearchNode, s conversion.Scope) error {
	...
	// WARNING: in.HeapSizePercentage requires manual conversion: does not exist in peer-type
	out.Storage = (*v1.PersistentVolumeClaimSpec)(unsafe.Pointer(in.Storage))
	out.Resources = in.Resources
	out.MaxUnavailable = (*intstr.IntOrString)(unsafe.Pointer(in.MaxUnavailable))
	return nil
...
func autoConvert_v1alpha2_MariaDBSpec_To_v1alpha1_MariaDBSpec(in *v1alpha2.MariaDBSpec, out *MariaDBSpec, s conversion.Scope) error {
	...
	out.Storage = (*v1.PersistentVolumeClaimSpec)(unsafe.Pointer(in.Storage))
	// WARNING: in.AuthSecret requires manual conversion: does not exist in peer-type
	// WARNING: in.WsrepSSTMethod requires manual conversion: does not exist in peer-type
	if in.Init != nil {
		in, out := &in.Init, &out.Init
		*out = new(InitSpec)
		if err := Convert_v1alpha2_InitSpec_To_v1alpha1_InitSpec(*in, *out, s); err != nil {
...
func autoConvert_v1alpha2_MongoDBConfigNode_To_v1alpha1_MongoDBConfigNode(in *v1alpha2.MongoDBConfigNode, out *MongoDBConfigNode, s conversion.Scope) error {
	...
	out.Storage = (*v1.PersistentVolumeClaimSpec)(unsafe.Pointer(in.Storage))
	// WARNING: in.EphemeralStorage requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v1alpha2_PerconaXtraDBSpec_To_v1alpha1_PerconaXtraDBSpec(in *v1alpha2.PerconaXtraDBSpec, out *PerconaXtraDBSpec, s conversion.Scope) error {
	...
	// WARNING: in.AllowedSchemas requires manual conversion: does not exist in peer-type
	// WARNING: in.HealthChecker requires manual conversion: does not exist in peer-type
	// WARNING: in.SystemUserSecrets requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v1alpha2_RedisSpec_To_v1alpha1_RedisSpec(in *v1alpha2.RedisSpec, out *RedisSpec, s conversion.Scope) error {
	...
	// WARNING: in.SentinelRef requires manual conversion: does not exist in peer-type
