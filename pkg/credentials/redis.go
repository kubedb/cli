...
type RedisShowCred struct {
	client   kubernetes.Interface
	dbClient cs.KubedbV1alpha2Interface
}

func NewRedisShowCred(clientConfig *rest.Config) (*RedisShowCred, error) {
	...
	return &RedisShowCred{
		dbClient: dbClient,
		client:   client,
	}, nil
}

func (e *RedisShowCred) GetCred(name, namespace string) (map[string][]byte, error) {
