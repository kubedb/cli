...
type ElasticsearchShowCred struct {
	client   kubernetes.Interface
	dbClient cs.KubedbV1alpha2Interface
}

func NewElasticsearchShowCred(clientConfig *rest.Config) (*ElasticsearchShowCred, error) {
	...
	return &ElasticsearchShowCred{
		dbClient: dbClient,
		client:   client,
	}, nil
}

func (e *ElasticsearchShowCred) GetCred(name, namespace string) (map[string][]byte, error) {
