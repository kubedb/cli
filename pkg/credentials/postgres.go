...
type PostgresShowCred struct {
	client   kubernetes.Interface
	dbClient cs.KubedbV1alpha2Interface
}

func NewPostgresShowCred(clientConfig *rest.Config) (*PostgresShowCred, error) {
	...
	return &PostgresShowCred{
		dbClient: dbClient,
		client:   client,
	}, nil
}

func (e *PostgresShowCred) GetCred(name, namespace string) (map[string][]byte, error) {
