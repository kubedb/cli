...
func (opts *mariadbOpts) collectOperatorLogs() error {
...
func (opts *mariadbOpts) writeLogs(podName, ns, container string) error {
...
func (opts *mariadbOpts) collectOtherYamls() error {
	opsReqs, err := opts.dbClient.OpsV1alpha1().MariaDBOpsRequests(opts.db.Namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
		return err
	}
	...
	scalers, err := opts.dbClient.AutoscalingV1alpha1().MariaDBAutoscalers(opts.db.Namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
		return err
	}
