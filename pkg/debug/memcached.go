...
func MemcachedDebugCMD(f cmdutil.Factory) *cobra.Command {
	var (
		dbName            string
	...
	mdDebugCmd := &cobra.Command{
		...
		Short:   "Debug helper for Memcached database",
		Example: `kubectl dba debug memcached -n demo sample-memcached --operator-namespace kubedb`,
